...
namespace CDC
{
	public abstract class Gex3Model : Model
	{
		#region Normals
		...
		protected Gex3Model(BinaryReader reader, DataFile dataFile, UInt32 dataStart, UInt32 modelData, String modelName, Platform ePlatform, UInt32 version, TPages tPages)
		{
			_dataFile = dataFile;
			_name = modelName;
			_modelTypePrefix = "";
