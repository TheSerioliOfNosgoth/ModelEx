...
namespace CDC
{
	public class Gex2File : DataFile
	{
		...
		protected Gex2File(String name, ExportOptions options, BinaryReader reader)
		{
			_name = name;
			_game = Game.Gex2;
			_asset = Asset.Object;
		...
		public Gex2File(String dataFileName, Platform platform, ExportOptions options)
			: base(dataFileName, Game.Gex2, platform, options)
		{
		}
		...
		protected override void ReadObjectData(BinaryReader reader, ExportOptions options)
		{
			...
			for (UInt16 m = 0; m < _modelCount; m++)
			{
				...
				Gex2ObjectModel model = new Gex2ObjectModel(reader, this, _dataStart, modelData, modelName, _platform, _version, _tPages);
		...
		protected override void ReadUnitData(BinaryReader reader, ExportOptions options)
		{
			...
			{
				reader.BaseStream.Position = _introStart + 0x30 * i;
			...
			Gex2UnitModel model = new Gex2UnitModel(reader, this, _dataStart, modelData, _name, _platform, _version, _tPages);
			model.ReadData(reader, options);
			_models[0] = model;
		}
