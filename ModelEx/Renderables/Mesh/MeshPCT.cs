...
namespace ModelEx
{
	public class MeshPCT : MeshIndexed
	{
		protected EffectWrapperGouraudTexture _effect = ShaderManager.Instance.effectGouraudTexture;
		protected string _technique = "";

		public MeshPCT(RenderResource resource, IMeshParserIndexed<PositionColorTexturedVertex, short> meshParser)
			: base(resource)
		{
